...
class Banco:
    def __init__(self,
                 agencias: list[int] or None = None,
                 clientes: list[pessoas.Pessoa] or None = None,
                 contas: list[contas.Conta] or None = None):
...
if __name__ == '__main__':
    c1 = pessoas.Cliente('Théo', 30)
    cc1 = contas.ContaCorrente(111, 222, 0, 0)
    c1.conta = cc1
    c2 = pessoas.Cliente('Mel', 18)
